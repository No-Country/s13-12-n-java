...
export default function OrdersTable() {
  ...
  return (
    <div>
      ...
      <div className="grid gap-y-3 bg-semi-white auto-rows-auto overflow-y-auto py-2 h-60">
        {orders.map((order) => (
          <div className="grid grid-cols-6 justify-items-center items-center h-9" key={order.orderNumber}>
